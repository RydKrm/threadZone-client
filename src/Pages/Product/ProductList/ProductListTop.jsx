   ...
   const setProduct = (e) =>{
    ...
    return (
      ...
      <div className="flex gap-2 ml-auto">
        <div className='border border-cDarkBlue w-10 h-9 flex items-center justify-center rounded cursor-pointer text-cDarkLight'>
           <FontAwesomeIcon icon={faBorderAll} /> 
           {/* <FontAwesomeIcon icon={faPenNib} /> */}
        </div>

        <div className='border border-cDarkBlue w-10 h-9 flex items-center justify-center rounded cursor-pointer flex-gray-600'>
