...
const SidebarCategory = ({allCategory}) => {
...
{/*         
        ...
        <div className="space-y-2 px-5 hover:text-cDarkBlue">
            <div className="flex items-center">
                ...
                <label htmlFor="Bed Room" className='text-gray-600 ml-3 cursor-pointer '>Women</label>
                <div className="ml-auto text-gray-600 text-sm">(15)</div>
            </div> 
        </div>
        ...
        <div className="space-y-2 px-5 hover:text-cDarkBlue">
            <div className="flex items-center">
                <input type="checkbox" className='text-primary focus:right-0 rounded-sm cursor-pointer'/>
                <label htmlFor="Bed Room" className='text-gray-600 ml-3 cursor-pointer '>Shirt</label>
                <div className="ml-auto text-gray-600 text-sm">(15)</div>
            </div> 
        </div>
        ...
        <div className="space-y-2 px-5 hover:text-cDarkBlue">
            <div className="flex items-center">
                <input type="checkbox" className='text-primary focus:right-0 rounded-sm cursor-pointer'/>
                <label htmlFor="Bed Room" className='text-gray-600 ml-3 cursor-pointer '>Pants</label>
                <div className="ml-auto text-gray-600 text-sm">(15)</div>
            </div> 
        </div> */}
        </div>
